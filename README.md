...
- scrollable logging sidebar with draggable, reversible, insertable, click-to-remove draft points, click-to-insert draft lines, and waypoint snapping to fitted route geometry while drawing routes
