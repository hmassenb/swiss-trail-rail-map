...
- GPX imports use the GPX track name/time when present and can fall back to cleaned filenames plus common filename dates such as `2021-08-14`, `20210814`, or `14.08.2021`.
