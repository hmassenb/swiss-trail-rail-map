...
- scrollable logging sidebar with draggable, reversible, insertable, click-to-remove draft points while drawing routes
...
4. Improve route editing
   ...
   - Snap inserted waypoints to nearby hiking paths or rail stations.
