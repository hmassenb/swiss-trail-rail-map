...
- saved-route action key and accessible per-route controls for zoom, overview, edit, copy, merge, map-previewed split, export, hike elevation recalculation, and delete
...
2. Improve route editing
   ...
   - Add a richer point picker for choosing split locations directly from the route geometry.
